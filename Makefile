...
ifeq ($(PLATFORM),native)
  ...
  SDL_LIBS ?= -L$(TG5040_SDK_USR)/lib -Wl,-rpath-link,$(TG5040_SDK_USR)/lib -lSDL2 -lSDL2_ttf -lSDL2_image -lfreetype -lbz2 -lz
  CURL_CFLAGS ?= -I$(TG5040_CURL_PREFIX)/include
  CURL_LIBS ?= -L$(TG5040_CURL_PREFIX)/lib -lcurl -L$(TG5040_SDK_USR)/lib -lssl -lcrypto -lz -pthread

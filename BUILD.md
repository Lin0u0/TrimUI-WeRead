...
4. Run `make test-nextui-launch-smoke`
5. Run `make test-package-audit-smoke`
6. Run `make package-all`
7. Run `make package-audit-all`
8. Run optional real-device smoke on tg5040 hardware before tagging
